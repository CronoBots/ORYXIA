...
(function () {
  ...
  function renderRound(cyShift, octx, reeded) {
    ...
    // textes gravés
    if (state.showText) { const txtR = R * 0.86; drawCurvedText(octx, cx, cy, txtR, state.text.toUpperCase(), m, false); if (state.subtext) drawCurvedText(octx, cx, cy, txtR, state.subtext.toUpperCase(), m, true); }
  }
